...
net stop "W3SVC" /y
rem net stop "VMware NAT Service" /y
rem net stop "VMUSBArbService" /y
rem net stop "VMnetDHCP" /y
rem net stop "VMAuthdService" /y
...
rem taskkill /F /IM HPHotkeyNotification.exe
taskkill /F /IM igfxEM.exe
taskkill /F /IM Microsoft.Photos.exe
taskkill /F /IM MicTray64.exe
rem taskkill /F /IM SmartAudio3.exe
...
net stop "TokenBroker" /y
rem net stop "Hyper File Server : SERVEUR" /y
rem net stop "MantaManager" /y
net stop "sshd" /y
net stop "IKEEXT" /y
